...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            option = Validacao.validarOpcao(sc);
    ...
    private static void listarDonos() {
        ...
        for (int i = 0; i < ListaDono.size(); i++) {
            System.out.println(i + 1);
        }
    ...
    private static void deletarPets() {// XXX É obrigatorio excluir um pet, caso digite errado fica preso
        ...
        int indice = Validacao.validarInteiro(sc, "Digite o número do pet que deseja remover: ", 1, ListaPets.size())
                - 1;
